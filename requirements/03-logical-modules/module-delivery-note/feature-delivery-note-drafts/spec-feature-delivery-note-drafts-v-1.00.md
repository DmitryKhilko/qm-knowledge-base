...
- SUC-DRAFTS-001: Сокращение количества жалоб и инцидентов, связанных с потерей данных при создании накладных, на 90% 
по сравнению со среднемесячным количеством за квартал до внедрения. Источник: система поддержки. 
- SUC-DRAFTS-002: Не менее 90% создаваемых в системе накладных, подлежащих заполнению группой специалистов, проходят 
через публичные черновики в течение квартала после внедрения. Источник: аналитика системы. 
- SUC-DRAFTS-003: Удовлетворенность пользователей функциональностью управления черновиками ≥ 4.5 из 5. Источник: 
опрос пользователей.
...
**BG:** [BG-DRAFTS-004](#bg-drafts-004), [BG-DRAFTS-005](#bg-drafts-005)  
...
**BG:** [BG-DRAFTS-004](#bg-drafts-004)  
...
**BG:** [BG-DRAFTS-005](#bg-drafts-005)    
...
[NFR-PQ-PE-TB-DRAFTS-001][4]) через интервал, заданный параметром draft_save_interval,  
