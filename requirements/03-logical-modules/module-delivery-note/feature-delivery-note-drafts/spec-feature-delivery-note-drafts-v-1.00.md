...
## 3.2.1 СОЗДАНИЕ ПРИВАТНОГО ЧЕРНОВИКА ПО ТРЕБОВАНИЮ ПОЛЬЗОВАТЕЛЯ
...
- AC 2: Поле "Создан" заполняется текущим временем сервера.
- AC 3: Поле "отредактирован" равно значению "Создан".
- AC 4: Созданный черновик доступен для просмотра и выбора в реестре приватных черновиков после успешного создания.
- AC 5: Пользователь остаётся на форме редактирования приватного черновика.
...
**Название:** Информирование пользователя об успешном создании приватного черновика 
**BG:** [BG-DELIVERY-NOTE-DRAFTS-001](#bg-delivery-note-drafts-001)  
**UC:** [UC-DELIVERY-NOTE-DRAFTS-CREATE-001, основной поток](#uc-delivery-note-drafts-create-001)  
**Тип:** create, event-driven  
...
**Критерии приемки:**
- AC 1: Уведомление появляется в нижней правой части экрана сразу после ответа сервера.
- AC 2: Цвет уведомления соответствует стилю «Success» (зеленый).
- AC 3: Текст сообщения: «Черновик успешно сохранен».
- AC 4: Уведомление исчезает автоматически через интервал от 3 до 5 секунд без действий пользователя.
- АС 5: Уведомление пользователь может закрыть вручную.

### FR-DELIVERY-NOTE-DRAFTS-CREATE-004
**Название:** Информирование пользователя об ошибке создания приватного черновика 
**BG:** [BG-DELIVERY-NOTE-DRAFTS-001](#bg-delivery-note-drafts-001)  
...
**Критерии приемки:**
- AC 1: Уведомление появляется в нижней правой части экрана сразу после ответа сервера.
- AC 2: Цвет уведомления соответствует стилю «Error» (красный).
- AC 3: Текст сообщения: «Не удалось сохранить черновик. Проверьте соединение и попробуйте ещё раз».
- AC 4: Уведомление исчезает автоматически через интервал от 3 до 5 секунд без действий пользователя.
- АС 5: Уведомление пользователь может закрыть вручную.
...
**Описание элемента:**
Кнопка создания/сохранения приватного черновика. Располагается правее кнопки "Сохранить". 

**Состояния:**
| Состояние | Условие отображения | Визуальные атрибуты |
| :--| :--| :--|
| Hidden (по умолчанию) | Форма накладной пуста (не заполнено не одно поле) ||
| Visible | Заполнено хотя бы одно поле формы накладной| Цвет: #FFFF, текст: "Сохранить черновик"|
|Saving|Производится процесс создания/сохранения приватного черновика|Текст скрыт, отображается Spinner-Small-White. Кнопка блокируется.|
|Success (Успех)|Получен ответ «Успешно» от сервера|Кнопка возвращается в Visible, текст не меняется|
| Hidden | Успешное сохранение накладной после нажатия кнопки "Сохранить" ||
