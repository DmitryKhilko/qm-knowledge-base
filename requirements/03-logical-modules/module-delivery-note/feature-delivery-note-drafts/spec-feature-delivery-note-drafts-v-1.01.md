...
Feature: Установка временных меток при создании приватного черновика по требованию пользователя  
    ...
    Background:  
        Given система создает новую запись в таблице черновиков базы данных
        When выполняется операция INSERT
...
Feature: Изменение значения счётчика количества черновиков при создании приватного черновика  
    ...
    Background: 
        ...
        When система успешно создает приватный черновик накладной
  
    Scenario: FR
        Then система увеличивает значение счётчика приватных черновиков до N + 1

    Scenario: AC1
        Then система автоматически обновляет на UI значение счётчика приватных черновиков
