...
Feature: Создание приватного черновика по требованию пользователя  
    ...
    Scenario: FR
        ...
        And в таблице базы данных создается новая уникальная запись с типом «Приватный»
        And значения полей "Создан" и "Отредактирован" соответствуют FR-DELIVERY-NOTE-DRAFTS-CREATE-003
