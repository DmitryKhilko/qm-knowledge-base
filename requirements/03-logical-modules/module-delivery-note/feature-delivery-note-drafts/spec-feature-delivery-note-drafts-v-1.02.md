ID: SPEC-FEATURE-DELIVERY-NOTE-DRAFTS-V-1.02  
Статус: Утверждено  
...
Feature: Создание приватного черновика по требованию пользователя  
    ...
    Scenario: FR
        ...
        And система в таблице базы данных создаёт новую уникальную запись с типом «Приватный»
        And система устанавливает значение поля новой записи "created_at" равным текущему времени сервера
        And система устанавливает значение поля новой записи "modified_at" равным текущему времени сервера
        And значение поля "created_at" соответствует формату "YYYY-MM-DD HH:MM:SS + 3"
        And значение поля "modified_at" соответствует формату "YYYY-MM-DD HH:MM:SS + 3"
        And разница между временем транзакции и значением поля "created_at" не превышает 1 секунду
...
Наименование: Кнопка создании приватного черновика, сохранении приватного/публичного черновика "Сохранить черновик"    
